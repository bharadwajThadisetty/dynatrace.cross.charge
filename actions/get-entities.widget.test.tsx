...
import GetEntitiesWidget from './get-entities.widget';

enableFetchMocks();

describe('GetEntitiesWidget', () => {
  beforeEach(() => {
  ...
  it('should render a widget with values', () => {
    ...
    fetchMock.mockIf(
      ...
      JSON.stringify({
        items: [
          {
            objectId: 'get-entities-connection-object-id',
    ...
    render(<GetEntitiesWidget value={{ entityType: 'full_stack', billingMetrics: '' }} onValueChanged={jest.fn()} />);
  });
});
