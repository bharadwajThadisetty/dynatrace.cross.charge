...
import GetGenericEntityTypesWidget from './get-generic-entity-types.widget';

enableFetchMocks();

describe('GetGenericEntityTypesWidget', () => {
  beforeEach(() => {
  ...
  it('should render a widget with values', () => {
    ...
    fetchMock.mockIf(
      ...
      JSON.stringify({
        items: [
          {
            objectId: 'get-generic-entity-types-connection-object-id',
    ...
    render(<GetGenericEntityTypesWidget value={{ name: 'Mark' }} onValueChanged={jest.fn()} />);
  });
});
