...
import GetEntityInformationWidget from './get-entity-information.widget';

enableFetchMocks();

describe('GetEntityInformationWidget', () => {
  beforeEach(() => {
  ...
  it('should render a widget with values', () => {
    ...
    fetchMock.mockIf(
      ...
      JSON.stringify({
        items: [
          {
            objectId: 'get-entity-information-connection-object-id',
    ...
    render(
      <GetEntityInformationWidget value={{ entity: 'HOST-000000000', tagKeys: 'App' }} onValueChanged={jest.fn()} />,
    );
  });
});
