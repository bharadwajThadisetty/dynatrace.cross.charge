...
import GetBillingUsageWidget from './get-billing-usage.widget';

enableFetchMocks();

describe('GetBillingUsageWidget', () => {
  beforeEach(() => {
  ...
  it('should render a widget with values', () => {
    ...
    fetchMock.mockIf(
      ...
      JSON.stringify({
        items: [
          {
            objectId: 'get-billing-usage-connection-object-id',
    ...
    render(<GetBillingUsageWidget value={{ entityType: 'Mark' }} onValueChanged={jest.fn()} />);
  });
});
